...
class CUTV_REST_Revisions_Controller extends CUTV_REST_Controller {
	...
	public function __construct( $parent_post_type ) {
		...
		$this->parent_controller = new CUTV_REST_Posts_Controller( $parent_post_type );
	 ...
	 *
	 * @param CUTV_REST_Request $request Full data about the request.
