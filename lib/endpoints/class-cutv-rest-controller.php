...
abstract class CUTV_REST_Controller {
	...
	public function register_routes() {
		_doing_it_wrong( 'CUTV_REST_Controller::register_routes', __( 'The register_routes() method must be overriden' ), 'WPAPI-2.0' );
	}
	 ...
	 *
	 * @param CUTV_REST_Response $response Response object.
	...
	public function get_post( $post ) {
		 ...
		 * Filter the post.
		 *
		 * Allows plugins to filter the post object as returned by `\CUTV_REST_Controller::get_post()`.
		 *
