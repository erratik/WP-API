...
class CUTV_REST_Attachments_Controller extends CUTV_REST_Posts_Controller {
	...
	public function update_item( $request ) {
		...
		/* This action is documented in lib/endpoints/class-cutv-rest-attachments-controller.php */
