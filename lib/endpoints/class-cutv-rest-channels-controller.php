 ...
 */
class CUTV_REST_Channels_Controller extends CUTV_REST_Controller {
     ...
     *
     * @param CUTV_REST_Request $request Full details about the request
     * @return CUTV_REST_Request|WP_Error
     */
    ...
    public function update_item( $request ) {
        ...
        /* This action is documented in lib/endpoints/class-cutv-rest-terms-controller.php */
    ...
    protected function prepare_links( $term ) {
        ...
        $links = array(
            ...
            'about'      => array(
                'href'       => rest_url( sprintf( 'cutv/v2/taxonomies/%s', $this->taxonomy ) ),
            ),
        );
        ...
        foreach ( $taxonomy_obj->object_type as $type ) {
            ...
            $post_type_links[] = array(
                'href' => add_query_arg( $this->rest_base, $term->term_id, rest_url( sprintf( 'cutv/v2/%s', $rest_base ) ) ),
            );
        }
