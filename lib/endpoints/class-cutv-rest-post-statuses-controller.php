...
class CUTV_REST_Post_Statuses_Controller extends CUTV_REST_Controller {
	 ...
	 * @param CUTV_REST_Request $request
	 * @return CUTV_REST_Response Post status data
	 */
	public function prepare_item_for_response( $status, $request ) {
		...
		if ( 'publish' === $status->name ) {
			$response->add_link( 'archives', rest_url( 'cutv/v2/posts' ) );
		} else {
			$response->add_link( 'archives', add_query_arg( 'status', $status->name, rest_url( 'cutv/v2/posts' ) ) );
		}
