 ...
 * Access users
 */
class CUTV_REST_Users_Controller extends CUTV_REST_Controller {
	...
	public function update_item( $request ) {
		...
		/* This action is documented in lib/endpoints/class-cutv-rest-users-controller.php */
	 ...
	 * @param CUTV_REST_Request $request Request object.
	 * @return CUTV_REST_Response $response Response data.
	 */
