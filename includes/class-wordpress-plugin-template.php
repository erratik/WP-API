...
//        CUTV_Channel()->register_post_type( 'listing', __( 'Listings', 'cutv-api' ), __( 'Listing', 'cutv-api' ) );
	...
	public function enqueue_scripts () {
		...
		wp_register_script( $this->_token . '-frontend', esc_url( $this->assets_url ) . 'js/frontend' . $this->script_suffix . '.js', array( 'jquery', 'underscore' , $this->_token . '-admin' , $this->_token . '-handlebars'), $this->_version );
...
//
	...
	public function admin_enqueue_styles ( $hook = '' ) {
		...
		wp_register_style( $this->_token . '-semantic', esc_url( $this->assets_url ) . 'css/semantic/semantic.min.css', array(), $this->_version );
...
//                echo ;
                    ...
                    wp_register_script($this->_token . '-admin', esc_url($this->assets_url) . 'js/admin' . $this->script_suffix . '.js', array('jquery', $this->_token . '-lodash', $this->_token . '-ctrl-main'), $this->_version);
                    wp_enqueue_script($this->_token . '-admin');
                }  else {
